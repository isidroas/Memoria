...
\titulo{Posicionamiento de un UAV Mediante los \mbox{Marcadores} Visuales \textit{Aruco} y el \mbox{Estimador} de Estados de \textit{PX4}} %\mbox evita que se divida una palabra al cambiar de línea
...
\portadaPFC{cabeceras/figuras/LogoUS.pdf} %logo de la Universidad y logo del departamento, si lo hubiera. Para cambiar el pie de página con los logos, debe editarse el fichero ediciónPFC.sty
...
\include{notacion} %No incluir si no se quiere, comentándolo
...
\include{estimador_px4/estimador_px4}
\include{posicionamiento_marcadores/posicionamiento_marcadores}
